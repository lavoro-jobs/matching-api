...
COPY ./lavoro-matching-api/requirements.txt /app/requirements.txt
...
COPY ./lavoro-matching-api/lavoro_matching_api /app/lavoro_matching_api
...
COPY ./lavoro_matching_api /app/lavoro_matching_api

ENV PYTHONPATH "${PYTHONPATH}:/app"

RUN pip install gunicorn

CMD ["gunicorn", "lavoro_matching_api.matching_api:app", "-w", "4", "-k", "uvicorn.workers.UvicornWorker", "-b", "0.0.0.0:80"]
